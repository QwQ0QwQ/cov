(async function () {
    ...
    var Crawler = function () {
        var newCrawler = {
            ...
            config: {
                ...
                traversePrototypes: false, /* Whether to traverse prototypes or stop before them */
    ...
    // make a crawler 
    var c = Crawler()
    // crawl the window object
    var g = await c.crawlAsync(window)
    // send string to playwright
