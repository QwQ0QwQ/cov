...
runAllTests.onclick = async e=>{
    ...
    let u = runCustomTestUrl.value
          , n = "Invalid URL";
    Ee(u) && (runCustomTestBtn.disabled = !0,
        runALLTestBtn.disabled = !1),
...
const Te = ()=>window.open("/blank.html", "targetWindow", `toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=yes,left=${screen.width - 250},width=250,height=250`)
