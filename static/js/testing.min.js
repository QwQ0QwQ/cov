const e = "https://crossorigin.xsinator.xyz/"
  , t = t=>({
    url0: `${e}${t}?0`,
    url1: `${e}${t}?1`
})
...
const g = e=>new Promise((t=>setTimeout(t, e)))
  ...
  , L = e=>new Promise((t=>setTimeout(t, e)));
let T = `${e}testcases/files/image1.gif`;
...
let x = `${e}testcases/files/image1.gif`;
const C = e=>new Promise((t=>setTimeout(t, e)))
  ...
  , R = async e=>{
    for (e.location = "blank.html"; ; ) {
        try {
            if (e.location.pathname.includes("blank.html"))
                return await M(100),
                1
        } catch (e) {}
        await M(10)
...
var O = "webkitTransition"in document.head.style ? "webkitTransitionEnd" : "transitionend"
  , B = "webkitTransition"in document.head.style || "transition"in document.head.style
  , I = "webkitTransition"in document.head.style ? "webkitTransitionDuration" : "transitionDuration"
  , j = "webkitTransition"in document.head.style ? "webkitTransitionProperty" : "transitionProperty";
function q(e) {
    var t = getComputedStyle(e)
      , n = t[j]
      , s = t[I]
      , a = s.includes("ms") ? 1 : 1e3
      , o = B && n && "none" !== n ? parseFloat(s) * a : 0;
...
function Z(e) {
    ...
    function r(e) {
        n = e && e.target.closest(".alert"),
        (t = U('[data-dismiss="alert"]', n)) && n && (t === e.target || t.contains(e.target)) && s.close()
    }
    function l() {
        i(),
    ...
    s.close = function() {
        if (n && t && n.classList.contains("show")) {
            ...
            n.classList.contains("fade") ? z(n, l) : l()
        }
    }
    ,
    s.dispose = function() {
...
function G(e) {
        ...
        if (r) {
            ...
            "checkbox" === r.type) {
                if (s.defaultPrevented)
                    return;
                r.checked ? (i.classList.remove("active"),
                r.getAttribute("checked"),
                r.removeAttribute("checked"),
                r.checked = !1) : (i.classList.add("active"),
                r.getAttribute("checked"),
            ...
            if ("radio" === r.type && !t.toggled) {
                if (s.defaultPrevented)
                    return;
                (!r.checked || 0 === e.screenX && 0 === e.screenY) && (i.classList.add("active"),
                ...
                Array.from(n).forEach((function(e) {
                    ...
                    e !== i && e.classList.contains("active") && (V.call(t, s),
    ...
    ,
    (t = U(e)).Button && t.Button.dispose(),
    (n = t.getElementsByClassName("btn")).length && (t.Button || l(1),
    t.toggled = !1,
    t.Button = this,
    Array.from(n).forEach((function(e) {
        var t = U("input:checked", e);
        !e.classList.contains("active") && t && e.classList.add("active"),
        e.classList.contains("active") && !t && e.classList.remove("active")
    }
    )))
}
var J = "onmouseleave"in document ? ["mouseenter", "mouseleave"] : ["mouseover", "mouseout"]
  , Y = !!function() {
    var e = !1;
    try {
...
function Q(e, t) {
    var n, s, a, o, i, r, l, c, d, u, m, p, g, h = t || {}, f = this;
    function v() {
        !1 === r.interval || o.classList.contains("paused") || (o.classList.add("paused"),
        i.isSliding || (clearInterval(i.timer),
        i.timer = null))
    }
    function w() {
        !1 !== r.interval && o.classList.contains("paused") && (o.classList.remove("paused"),
        i.isSliding || (clearInterval(i.timer),
        i.timer = null,
        f.cycle()))
    }
    function y(e) {
        ...
        !i.isSliding) {
            var t = e.target;
            t && !t.classList.contains("active") && t.getAttribute("data-slide-to") && (i.index = +t.getAttribute("data-slide-to"),
            f.slideTo(i.index))
        }
    }
    function b(e) {
    ...
    function k(e) {
        ...
        r.pause && r.interval && (o[t](J[0], v, !1),
        o[t](J[1], w, !1),
        o[t]("touchstart", v, Y),
        o[t]("touchend", w, Y)),
        r.touch && d.length > 1 && o[t]("touchstart", T, Y),
        m && m[t]("click", b, !1),
        u && u[t]("click", b, !1),
        p && p[t]("click", y, !1),
        r.keyboard && window[t]("keydown", _, !1)
    }
    function L(e) {
        var t = e ? "addEventListener" : "removeEventListener";
        o[t]("touchmove", A, Y),
    ...
    function T(e) {
        i.isTouch || (i.touchPosition.startX = e.changedTouches[0].pageX,
        o.contains(e.target) && (i.isTouch = !0,
        L(1)))
    }
    function A(e) {
        i.isTouch ? (i.touchPosition.currentX = e.changedTouches[0].pageX,
        "touchmove" === e.type && e.changedTouches.length > 1 && e.preventDefault()) : e.preventDefault()
    }
    function E(e) {
        if (i.isTouch && !i.isSliding && (i.touchPosition.endX = i.touchPosition.currentX || e.changedTouches[0].pageX,
        i.isTouch)) {
            if ((!o.contains(e.target) || !o.contains(e.relatedTarget)) && Math.abs(i.touchPosition.startX - i.touchPosition.endX) < 75)
                return;
            i.touchPosition.currentX < i.touchPosition.startX ? i.index += 1 : i.touchPosition.currentX > i.touchPosition.startX && (i.index -= 1),
            i.isTouch = !1,
            f.slideTo(i.index),
            L()
        }
    ...
    function x(e) {
        if (i.touchPosition) {
            var t = i.index
              , n = e && e.target !== d[t] ? 1e3 * e.elapsedTime + 100 : 20
              , s = f.getActiveIndex()
              , a = "left" === i.direction ? "next" : "prev";
            i.isSliding && setTimeout((function() {
                i.touchPosition && (i.isSliding = !1,
                d[t].classList.add("active"),
                d[s].classList.remove("active"),
                d[t].classList.remove("carousel-item-" + a),
                d[t].classList.remove("carousel-item-" + i.direction),
                d[s].classList.remove("carousel-item-" + i.direction),
                V.call(o, c),
                document.hidden || !r.interval || o.classList.contains("paused") || f.cycle())
            }
            ), n)
        }
    }
    ...
    f.slideTo = function(e) {
        if (!i.isSliding) {
            var t = f.getActiveIndex()
              , n = e;
            if (t !== n) {
                t < n || 0 === t && n === d.length - 1 ? i.direction = "left" : (t > n || t === d.length - 1 && 0 === n) && (i.direction = "right"),
                n < 0 ? n = d.length - 1 : n >= d.length && (n = 0);
                var s = "left" === i.direction ? "next" : "prev"
                  , a = {
                    relatedTarget: d[n],
                ...
                l = X("slide", "carousel", a),
                c = X("slid", "carousel", a),
                V.call(o, l),
                l.defaultPrevented || (i.index = n,
                i.isSliding = !0,
                clearInterval(i.timer),
                i.timer = null,
                P(n),
                q(d[n]) && o.classList.contains("slide") ? (d[n].classList.add("carousel-item-" + s),
                K(d[n]),
                d[n].classList.add("carousel-item-" + i.direction),
                d[t].classList.add("carousel-item-" + i.direction),
                z(d[n], x)) : (d[n].classList.add("active"),
                K(d[n]),
                d[t].classList.remove("active"),
                setTimeout((function() {
                    i.isSliding = !1,
                    r.interval && o && !o.classList.contains("paused") && f.cycle(),
                    V.call(o, c)
                }
                ), 100)))
            }
    ...
    f.dispose = function() {
        ...
        Array.from(d).forEach((function(t, n) {
            t.classList.contains("active") && P(n),
    ...
    ,
    (o = U(e)).Carousel && o.Carousel.dispose(),
    d = o.getElementsByClassName("carousel-item"),
    n = o.getElementsByClassName("carousel-control-prev"),
    u = n[0],
    s = o.getElementsByClassName("carousel-control-next"),
    m = s[0],
    a = o.getElementsByClassName("carousel-indicators"),
    p = a[0],
    g = p && p.getElementsByTagName("LI") || [],
    !(d.length < 2)) {
        var C = o.getAttribute("data-interval")
          , S = "false" === C ? 0 : +C
          , F = "false" === o.getAttribute("data-touch") ? 0 : 1
          , W = "hover" === o.getAttribute("data-pause") || !1
          , $ = "true" === o.getAttribute("data-keyboard") || !1
          , N = h.interval
          , D = h.touch;
        (r = {}).keyboard = !0 === h.keyboard || $,
        r.pause = !("hover" !== h.pause && !W) && "hover",
        r.touch = D || F,
        r.interval = 5e3,
        "number" == typeof N ? r.interval = N : !1 === N || 0 === S || !1 === S ? r.interval = 0 : Number.isNaN(S) || (r.interval = S),
        f.getActiveIndex() < 0 && (d.length && d[0].classList.add("active"),
        g.length && P(0)),
        (i = {}).direction = "left",
        i.index = 0,
        i.timer = null,
...
function ee(e, t) {
    var n, s, a, o, i, r, l, c = t || {}, d = this, u = null, m = null;
    function p(e, t) {
        V.call(e, r),
        r.defaultPrevented || (e.isAnimating = !0,
    ...
    d.toggle = function(e) {
        (e && "A" === e.target.tagName || "A" === n.tagName) && e.preventDefault(),
        (n.contains(e.target) || e.target === n) && (m.classList.contains("show") ? d.hide() : d.show())
    }
    ,
    d.hide = function() {
        m.isAnimating || (p(m, n),
    ...
    d.show = function() {
        var e, t, r;
        u && (e = u.getElementsByClassName("collapse show"),
        s = e[0],
        a = s && (U('[data-target="#' + s.id + '"]', u) || U('[href="#' + s.id + '"]', u))),
        m.isAnimating || (a && s !== m && (p(s, a),
        a.classList.add("collapsed")),
        t = m,
        r = n,
        V.call(t, o),
        o.defaultPrevented || (t.isAnimating = !0,
    ...
    ,
    d.dispose = function() {
        n.removeEventListener("click", d.toggle, !1),
        delete n.Collapse
    }
    ,
    ...
    r = X("hide", "collapse"),
    l = X("hidden", "collapse"),
    null !== (m = U(c.target || n.getAttribute("data-target") || n.getAttribute("href"))) && (m.isAnimating = !1),
    u = n.closest(c.parent || g),
    n.Collapse || n.addEventListener("click", d.toggle, !1),
    n.Collapse = d
}
function te(e) {
    e.focus()
...
function ne(e, t) {
    ...
    function g() {
        ...
        document[e]("click", h, !1),
        document[e]("keydown", v, !1),
        document[e]("keyup", w, !1),
        document[e]("focus", h, !1)
    }
    function h(e) {
        var t = e.target;
        if (t.getAttribute) {
            var s = t && t.getAttribute("data-toggle") || t.parentNode && t.parentNode.getAttribute && t.parentNode.getAttribute("data-toggle");
            ("focus" !== e.type || t !== n && t !== l && !l.contains(t)) && (t !== l && !l.contains(t) || !c && !s) && (u = t === n || n.contains(t) ? n : null,
            d.hide(),
            p.call(e, t))
        }
    }
    ...
    function w(e) {
        var t = e.which || e.keyCode
          ...
          , a = s === n
          , o = l.contains(s)
          , i = s.parentNode === l || s.parentNode.parentNode === l
          , r = m.indexOf(s);
        i && (a ? r = 0 : 38 === t ? r = r > 1 ? r - 1 : 0 : 40 === t && (r = r < m.length - 1 ? r + 1 : r),
        m[r] && te(m[r])),
        (m.length && i || !m.length && (o || a) || !o) && n.open && 27 === t && (d.toggle(),
        u = null)
    }
    d.show = function() {
        s = X("show", "dropdown", {
        ...
        V.call(r, s),
        s.defaultPrevented || (l.classList.add("show"),
        r.classList.add("show"),
        n.setAttribute("aria-expanded", !0),
        n.open = !0,
        n.removeEventListener("click", f, !1),
        setTimeout((function() {
            te(l.getElementsByTagName("INPUT")[0] || n),
            g(),
            a = X("shown", "dropdown", {
                relatedTarget: u
            }),
    ...
    d.hide = function() {
        ...
        V.call(r, o),
        o.defaultPrevented || (l.classList.remove("show"),
    ...
    ,
    d.dispose = function() {
        r.classList.contains("show") && n.open && d.hide(),
        n.removeEventListener("click", f, !1),
        delete n.Dropdown
    }
    ,
    (n = U(e)).Dropdown && n.Dropdown.dispose(),
    r = n.parentNode,
    l = U(".dropdown-menu", r),
    Array.from(l.children).forEach((function(e) {
        e.children.length && "A" === e.children[0].tagName && m.push(e.children[0]),
        "A" === e.tagName && m.push(e)
    }
    )),
    n.Dropdown || ("tabindex"in l || l.setAttribute("tabindex", "0"),
    n.addEventListener("click", f, !1)),
    c = !0 === t || "true" === n.getAttribute("data-persist") || !1,
    n.open = !1,
    n.Dropdown = d
}
function se(e, t) {
    var n, s, a, o, i, r, l, c, d, u, m = t || {}, p = this, g = null, h = {};
    function f() {
        var e = document.body.classList.contains("modal-open")
          , t = parseInt(getComputedStyle(document.body).paddingRight, 10)
        ...
        s.style.paddingRight = !c && l ? l + "px" : "",
        document.body.style.paddingRight = c || r ? t + (e ? 0 : l) + "px" : "",
    ...
    function v() {
        (c = U(".modal-backdrop")) && !document.getElementsByClassName("modal show")[0] && (document.body.removeChild(c),
        c = null),
        null === c && (document.body.classList.remove("modal-open"),
    ...
    function w(e) {
        var t = e ? "addEventListener" : "removeEventListener";
        window[t]("resize", p.update, Y),
        s[t]("click", T, !1),
        document[t]("keydown", L, !1)
    }
    function y() {
        ...
        s.classList.contains("fade") ? z(s, b) : b()
    }
    function b() {
        te(s),
        s.isAnimating = !1,
    ...
    function _(e) {
        ...
        n && te(n),
        c = U(".modal-backdrop"),
        1 !== e && c && c.classList.contains("show") && !document.getElementsByClassName("modal show")[0] ? (c.classList.remove("show"),
        z(c, v)) : v(),
        w(),
        s.isAnimating = !1,
        r = X("hidden", "modal"),
    ...
    function k(e) {
        if (!s.isAnimating) {
            var t = e.target
              , a = "#" + s.getAttribute("id")
              , o = t.getAttribute("data-target") || t.getAttribute("href")
              , i = n.getAttribute("data-target") || n.getAttribute("href");
            !s.classList.contains("show") && (t === n && o === a || n.contains(t) && i === a) && (s.modalTrigger = n,
            g = n,
            p.show(),
            e.preventDefault())
        }
    ...
    function T(e) {
        if (!s.isAnimating) {
            var t = e.target
              , n = "modal" === t.getAttribute("data-dismiss")
              , a = t.closest('[data-dismiss="modal"]');
            s.classList.contains("show") && (a || n || t === s && "static" !== h.backdrop) && (p.hide(),
            g = null,
            e.preventDefault())
        }
    }
    ...
    p.show = function() {
        ...
        a.defaultPrevented))) {
            ...
            t && t !== s && (t.modalTrigger && t.modalTrigger.Modal.hide(),
            t.Modal && t.Modal.hide()),
            h.backdrop && (e = document.createElement("div"),
            null === (c = U(".modal-backdrop")) && (e.setAttribute("class", "modal-backdrop" + (h.animation ? " fade" : "")),
            c = e,
            document.body.appendChild(c)),
            c = c),
            !c || t || c.classList.contains("show") || (K(c),
            d = q(c),
            c.classList.add("show")),
            t ? y() : setTimeout(y, c && d ? d : 0)
        }
    }
    ,
    p.hide = function(e) {
        s.classList.contains("show") && (i = X("hide", "modal"),
        V.call(s, i),
        i.defaultPrevented || (s.isAnimating = !0,
        s.classList.remove("show"),
        s.setAttribute("aria-hidden", !0),
        s.classList.contains("fade") && 1 !== e ? z(s, _) : _()))
    }
    ,
    ...
    p.dispose = function() {
        p.hide(1),
        n ? (n.removeEventListener("click", k, !1),
        delete n.Modal) : delete s.Modal
    }
    ,
    n = U(e);
    var A = U(n.getAttribute("data-target") || n.getAttribute("href"));
    s = n.classList.contains("modal") ? n : A,
    u = Array.from(document.getElementsByClassName("fixed-top")).concat(Array.from(document.getElementsByClassName("fixed-bottom"))),
    n.classList.contains("modal") && (n = null),
    n && n.Modal && n.Modal.dispose(),
    s && s.Modal && s.Modal.dispose(),
    h.keyboard = !(!1 === m.keyboard || "false" === s.getAttribute("data-keyboard")),
    h.backdrop = "static" !== m.backdrop && "static" !== s.getAttribute("data-backdrop") || "static",
    h.backdrop = !1 !== m.backdrop && "false" !== s.getAttribute("data-backdrop") && h.backdrop,
    h.animation = !!s.classList.contains("fade"),
    h.content = m.content,
    s.isAnimating = !1,
    n && !n.Modal && n.addEventListener("click", k, !1),
    h.content && p.setContent(h.content.trim()),
    n ? (s.modalTrigger = n,
    n.Modal = p) : s.Modal = p
}
var ae = "mousedown";
...
function ie(e, t, n, s) {
    ...
    E = "right" === (E = "left" === (E = "bottom" === (E = "top" === (E = ("left" === E || "right" === E) && L && A ? "top" : E) && k ? "bottom" : E) && T ? "top" : E) && L ? "right" : E) && A ? "left" : E,
    -1 === t.className.indexOf(E) && (t.className = t.className.replace(/\b(top|bottom|left|right)+/, E));
    var P = v.offsetWidth
      , x = v.offsetHeight;
    "left" === E || "right" === E ? (o = "left" === E ? m.left + p.x - l - (f ? P : 0) : m.left + p.x + g,
    w ? (a = m.top + p.y,
    i = h / 2 - P) : _ ? (a = m.top + p.y - c + h,
    i = c - h / 2 - P) : (a = m.top + p.y - c / 2 + h / 2,
    i = c / 2 - (f ? .9 * x : x / 2))) : "top" !== E && "bottom" !== E || (a = "top" === E ? m.top + p.y - c - (f ? x : 0) : m.top + p.y + h,
    y ? (o = 0,
    r = m.left + g / 2 - P) : b ? (o = d - 1.01 * l,
    r = l - (d - m.left) + g / 2 - P / 2) : (o = m.left + p.x - l / 2 + g / 2,
    r = l / 2 - (f ? P : P / 2))),
    t.style.top = a + "px",
    t.style.left = o + "px",
    i && (v.style.top = i + "px"),
...
function re(e, t) {
    var n, s, a, o, i, r, l, c, d, u, m = t || {}, p = this, g = null, h = 0, f = /(iPhone|iPod|iPad)/.test(navigator.userAgent), v = {};
    function w(e) {
        null !== g && e.target === U(".close", g) && p.hide()
    }
    function y() {
        return {
            0: m.title || s.getAttribute("data-title") || null,
            1: m.content || s.getAttribute("data-content") || null
        }
    }
    function b() {
        null === g && s.focus()
    ...
    function _(e) {
        var t = e ? "addEventListener" : "removeEventListener";
        "hover" === v.trigger ? (s[t](ae, p.show),
        s[t](J[0], p.show),
        v.dismissible || s[t](J[1], p.hide)) : "click" === v.trigger ? s[t](v.trigger, p.toggle) : "focus" === v.trigger && (f && s[t]("click", b, !1),
        s[t](v.trigger, p.toggle))
    }
    function k(e) {
    ...
    function L(e) {
        var t = e ? "addEventListener" : "removeEventListener";
        v.dismissible ? document[t]("click", w, !1) : ("focus" === v.trigger && s[t]("blur", p.hide),
        "hover" === v.trigger && document[t]("touchstart", k, Y)),
        window[t]("resize", p.hide, Y)
    }
    function T() {
        L(1),
        V.call(s, c)
        ...
        h = setTimeout((function() {
            if (null === g) {
                ...
                !function() {
                    ...
                    g.appendChild(t),
                    null !== o && null === v.template) {
                        if (g.setAttribute("role", "tooltip"),
                        null !== a) {
                            var n = document.createElement("h3");
                            n.classList.add("popover-header"),
                            n.innerHTML = v.dismissible ? a + r : a,
                            g.appendChild(n)
                        }
                        var s = document.createElement("div");
                        s.classList.add("popover-body"),
                        s.innerHTML = v.dismissible && null === a ? o + r : o,
                        g.appendChild(s)
                    } else {
                        var l = document.createElement("div");
                        l.innerHTML = v.template.trim(),
                        g.className = l.firstChild.className,
                        g.innerHTML = l.firstChild.innerHTML;
                        var c = U(".popover-header", g)
                          , d = U(".popover-body", g);
                        a && c && (c.innerHTML = a.trim()),
                        o && d && (d.innerHTML = o.trim())
                    }
                    v.container.appendChild(g),
                    g.style.display = "block",
                    g.classList.contains("popover") || g.classList.add("popover"),
                    g.classList.contains(v.animation) || g.classList.add(v.animation),
                    g.classList.contains(i) || g.classList.add(i)
                }(),
                ie(s, g, v.placement, v.container),
                g.classList.contains("show") || g.classList.add("show"),
                v.animation ? z(g, T) : T()
            }
        }
        ), 20)
    ...
    var E = s.getAttribute("data-trigger")
      , P = s.getAttribute("data-animation")
      , x = s.getAttribute("data-placement")
      , C = s.getAttribute("data-dismissible")
      , S = s.getAttribute("data-delay")
      , F = s.getAttribute("data-container");
    r = '<button type="button" class="close">×</button>',
    l = X("show", "popover"),
    c = X("shown", "popover"),
    d = X("hide", "popover"),
    u = X("hidden", "popover");
    var W = U(m.container)
      , $ = U(F)
      , N = s.closest(".modal")
      , D = s.closest(".fixed-top")
      , R = s.closest(".fixed-bottom");
    v.template = m.template ? m.template : null,
    v.trigger = m.trigger ? m.trigger : E || "hover",
    v.animation = m.animation && "fade" !== m.animation ? m.animation : P || "fade",
    v.placement = m.placement ? m.placement : x || "top",
    v.delay = parseInt(m.delay || S, 10) || 200,
    v.dismissible = !(!m.dismissible && "true" !== C),
    v.container = W || $ || D || R || N || document.body,
    i = "bs-popover-" + v.placement,
    n = y(),
    a = n[0],
    ((o = n[1]) || v.template) && (s.Popover || _(1),
    s.Popover = p)
}
function le(e, t) {
    var n, s, a, o, i, r = t || {}, l = this, c = {};
    function d(e) {
        var t = e ? "addEventListener" : "removeEventListener";
        i[t]("scroll", l.refresh, Y),
        window[t]("resize", l.refresh, Y)
    }
    function u() {
    ...
    l.refresh = function() {
        if (function() {
            ...
            s.scrollTop = s.isWindow ? oe().y : n.scrollTop,
            (s.length !== a.length || u() !== s.scrollHeight) && (s.items = [],
            s.offsets = [],
            s.scrollHeight = u(),
            s.maxScroll = s.scrollHeight - (s.isWindow ? window.innerHeight : n.getBoundingClientRect().height),
            Array.from(a).forEach((function(n) {
                e = n.getAttribute("href"),
                (t = e && "#" === e.charAt(0) && "#" !== e.slice(-1) && U(e)) && (s.items.push(n),
                i = t.getBoundingClientRect(),
                s.offsets.push((s.isWindow ? i.top + s.scrollTop : t.offsetTop) - c.offset))
            }
            )),
        ...
        s.scrollTop >= s.maxScroll) {
            ...
            if (s.activeItem && s.scrollTop < s.offsets[0] && s.offsets[0] > 0)
                return s.activeItem = null,
                void m();
            for (var t = s.length; t > -1; )
                s.activeItem !== s.items[t] && s.scrollTop >= s.offsets[t] && (void 0 === s.offsets[t + 1] || s.scrollTop < s.offsets[t + 1]) && p(s.items[t]),
                t -= 1
        }
    }
    ,
    ...
    var g = n.getAttribute("data-target")
      , h = n.getAttribute("data-offset");
    o = U(r.target || g),
    i = n.clientHeight < n.scrollHeight ? n : window,
    o && (c.offset = +(r.offset || h) || 10,
    (s = {}).length = 0,
    s.items = [],
    s.offsets = [],
    s.isWindow = i === window,
...
function ce(e, t) {
    var n, s, a, o, i, r, l, c, d, u, m, p, g, h, f = t || {}, v = this, w = !1;
    function y() {
        w.style.height = "",
        w.classList.remove("collapsing"),
        s.isAnimating = !1
    }
    function b() {
    ...
    function _() {
        ...
        V.call(c, o),
        o.defaultPrevented || (m.classList.add("active"),
        u.classList.remove("active"),
        w && (h = m.scrollHeight,
        g = h === p,
        w.classList.add("collapsing"),
        w.style.height = p + "px",
        K(w),
        u.style.float = "",
        m.style.float = ""),
        m.classList.contains("fade") ? setTimeout((function() {
    ...
    function k() {
        ...
        return 1 !== e.length || e[0].parentNode.classList.contains("dropdown") ? e.length > 1 && (d = e[e.length - 1]) : d = e[0],
        d
    }
    function L() {
    ...
    function T(e) {
        e.preventDefault(),
        c = e.currentTarget,
        s.isAnimating || v.show()
    }
    v.show = function() {
        if (!(c = c || n).classList.contains("active")) {
            if (m = U(c.getAttribute("href")),
            d = k(),
            u = L(),
            r = X("hide", "tab", {
                relatedTarget: c
            ...
            a && (n.parentNode.classList.contains("dropdown-menu") ? a.classList.contains("active") || a.classList.add("active") : a.classList.contains("active") && a.classList.remove("active")),
            u.classList.contains("fade") ? (u.classList.remove("show"),
            z(u, _)) : _()
        }
    }
    ,
    v.dispose = function() {
        n.removeEventListener("click", T, !1),
        delete n.Tab
    }
    ,
    ...
    s = n.closest(".nav"),
    a = s && U(".dropdown-toggle", s);
    var E = !(!B || !1 === f.height || "false" === A);
    s.isAnimating = !1,
    n.Tab || n.addEventListener("click", T, !1),
    E && (w = L().parentNode),
    n.Tab = v
}
function de(e, t) {
    var n, s, a, o, i, r, l = t || {}, c = this, d = 0, u = {};
    function m() {
    ...
    function h() {
        clearTimeout(d),
        n.removeEventListener("click", c.hide, !1),
        delete n.Toast
    }
    c.show = function() {
        if (s && !s.classList.contains("show")) {
            ...
            a.defaultPrevented)
                return;
            u.animation && s.classList.add("fade"),
    ...
    ,
    (n = U(e)).Toast && n.Toast.dispose(),
    s = n.closest(".toast");
    var f = n.getAttribute("data-animation")
      , v = n.getAttribute("data-autohide")
      , w = n.getAttribute("data-delay");
    a = X("show", "toast"),
    o = X("hide", "toast"),
    i = X("shown", "toast"),
    r = X("hidden", "toast"),
    u.animation = !1 === l.animation || "false" === f ? 0 : 1,
    u.autohide = !1 === l.autohide || "false" === v ? 0 : 1,
    u.delay = parseInt(l.delay || w, 10) || 500,
    n.Toast || n.addEventListener("click", c.hide, !1),
    n.Toast = c
}
function ue(e, t) {
    var n, s, a, o, i, r, l, c = t || {}, d = this, u = null, m = 0, p = {};
    function g() {
    ...
    function f(e) {
        var t = e ? "addEventListener" : "removeEventListener";
        document[t]("touchstart", h, Y),
        window[t]("resize", d.hide, Y)
    }
    function v() {
        f(1),
        V.call(n, i)
            ...
            if (null === u) {
                ...
                !1 !== function() {
                    if (s = g()) {
                        ...
                        p.template) {
                            var e = document.createElement("div");
                            e.innerHTML = p.template.trim(),
                            u.className = e.firstChild.className,
                            u.innerHTML = e.firstChild.innerHTML,
                            U(".tooltip-inner", u).innerHTML = s.trim()
                        } else {
                            var t = document.createElement("div");
                        ...
                        u.classList.contains("tooltip") || u.classList.add("tooltip"),
                        u.classList.contains(p.animation) || u.classList.add(p.animation),
                        u.classList.contains(a) || u.classList.add(a),
                        p.container.appendChild(u)
                    }
                }() && (ie(n, u, p.placement, p.container),
                u.classList.contains("show") || u.classList.add("show"),
                p.animation ? z(u, v) : v())
            }
        }
        ), 20)
    ...
    d.dispose = function() {
        y(),
        d.hide(),
        n.setAttribute("title", n.getAttribute("data-original-title")),
        n.removeAttribute("data-original-title"),
        delete n.Tooltip
    }
    ,
    (n = U(e)).Tooltip && n.Tooltip.dispose();
    var b = n.getAttribute("data-animation")
      , _ = n.getAttribute("data-placement")
      , k = n.getAttribute("data-delay")
      , L = n.getAttribute("data-container")
      , T = U(c.container)
      , A = U(L)
      , E = n.closest(".modal");
    o = X("show", "tooltip"),
    ...
    r = X("hide", "tooltip"),
    l = X("hidden", "tooltip");
    var P = n.closest(".fixed-top")
      , x = n.closest(".fixed-bottom");
    p.animation = c.animation && "fade" !== c.animation ? c.animation : b || "fade",
    p.placement = c.placement ? c.placement : _ || "top",
    p.template = c.template ? c.template : null,
    p.delay = parseInt(c.delay || k, 10) || 200,
    p.container = T || A || P || x || E || document.body,
    a = "bs-tooltip-" + p.placement,
    (s = g()) && (n.Tooltip || (n.setAttribute("data-original-title", s),
...
me.Alert = [Z, '[data-dismiss="alert"]'],
me.Button = [G, '[data-toggle="buttons"]'],
me.Carousel = [Q, '[data-ride="carousel"]'],
me.Collapse = [ee, '[data-toggle="collapse"]'],
me.Dropdown = [ne, '[data-toggle="dropdown"]'],
me.Modal = [se, '[data-toggle="modal"]'],
me.Popover = [re, '[data-toggle="popover"],[data-tip="popover"]'],
me.ScrollSpy = [le, '[data-spy="scroll"]'],
me.Tab = [ce, '[data-toggle="tab"]'],
me.Toast = [de, '[data-dismiss="toast"]'],
me.Tooltip = [ue, '[data-toggle="tooltip"],[data-tip="tooltip"]'],
document.body ? pe() : document.addEventListener("DOMContentLoaded", (function e() {
    pe(),
...
var ge = {
  ...
  , he = function(e) {
    var t = /\blang(?:uage)?-([\w-]+)\b/i
      ...
      , s = {
            ...
            DFS: function e(t, n, a, o) {
                ...
                for (var r in t)
                    if (t.hasOwnProperty(r)) {
                        ...
                        var l = t[r]
                          , c = s.util.type(l);
                        "Object" !== c || o[i(l)] ? "Array" !== c || o[i(l)] || (o[i(l)] = !0,
                        e(l, n, r, o)) : (o[i(l)] = !0,
                        e(l, n, null, o))
                    }
            }
        ...
        highlight: function(e, t, n) {
            ...
            return s.hooks.run("before-tokenize", o),
            o.tokens = s.tokenize(o.code, o.grammar),
            s.hooks.run("after-tokenize", o),
            a.stringify(s.util.encode(o.tokens), o.language)
        },
                ...
                for (var u in o)
                    if (o.hasOwnProperty(u) && o[u]) {
                        ...
                        for (var p = 0; p < m.length; ++p) {
                            ...
                            for (var _ = g.pattern || g, k = l.next, L = c; k !== n.tail && !(d && L >= d.reach); L += k.value.length,
                            k = k.next) {
                                var T = k.value;
                                ...
                                if (!(T instanceof a)) {
                                    ...
                                    if (v && k != n.tail.prev) {
                                        ...
                                        !(S = _.exec(t)))
                                            break;
                                        var E = S.index + (f && S[1] ? S[1].length : 0)
                                          , P = S.index + S[0].length
                                          , x = L;
                                        for (x += k.value.length; x <= E; )
                                            x += (k = k.next).value.length;
                                        if (L = x -= k.value.length,
                                        k.value instanceof a)
                                            continue;
                                        for (var C = k; C !== n.tail && (x < P || "string" == typeof C.value); C = C.next)
                                            A++,
                                            x += C.value.length;
                                        A--,
                                        T = t.slice(L, x),
                                    ...
                                    if (S) {
                                        ...
                                        L += W.length),
                                        r(n, D, A),
                                        k = i(n, D, new a(u,h ? s.tokenize(F, h) : F,y,F)),
                                        $ && i(n, k, $),
                                        1 < A && e(t, n, o, k.prev, L, {
                                            cause: u + "," + p,
                                            reach: N
                                        })
                                    }
    ...
    function r(e, t, n) {
        for (var s = t.next, a = 0; a < n && s !== e.tail; a++)
            s = s.next;
        (t.next = s).prev = t,
        e.length -= a
    }
    ...
    !e.document)
        return e.addEventListener && (s.disableWorkerMessageHandler || e.addEventListener("message", (function(t) {
            var n = JSON.parse(t.data)
              ...
              , o = n.code
              , i = n.immediateClose;
            e.postMessage(s.highlight(o, s.languages[a], a)),
            i && e.close()
        }
        ), !1)),
        s;
...
"undefined" != typeof module && module.exports && (module.exports = he),
"undefined" != typeof global && (global.Prism = he),
he.languages.markup = {
    comment: /<!--[\s\S]*?-->/,
    prolog: /<\?[\s\S]+?\?>/,
    doctype: {
...
he.languages.markup.tag.inside["attr-value"].inside.entity = he.languages.markup.entity,
he.languages.markup.doctype.inside["internal-subset"].inside = he.languages.markup,
he.hooks.add("wrap", (function(e) {
...
he.languages.html = he.languages.markup,
he.languages.mathml = he.languages.markup,
he.languages.svg = he.languages.markup,
he.languages.xml = he.languages.extend("markup", {}),
he.languages.ssml = he.languages.xml,
he.languages.atom = he.languages.xml,
he.languages.rss = he.languages.xml,
function(e) {
    var t = /("|')(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/;
    e.languages.css = {
        comment: /\/\*[\s\S]*?\*\//,
...
he.languages.javascript["class-name"][0].pattern = /(\b(?:class|interface|extends|implements|instanceof|new)\s+)[\w.\\]+/,
he.languages.insertBefore("javascript", "keyword", {
    regex: {
    ...
    parameter: [{
        ...
        lookbehind: !0,
        inside: he.languages.javascript
    }, {
...
he.languages.markup && he.languages.markup.tag.addInlined("script", "javascript"),
he.languages.js = he.languages.javascript,
function() {
    if ("undefined" != typeof self && self.Prism && self.document) {
        var e = "line-numbers"
          , t = /\n(?!$)/g
          , n = he.plugins.lineNumbers = {
            getLine: function(t, n) {
                if ("PRE" === t.tagName && t.classList.contains(e)) {
                    var s = t.querySelector(".line-numbers-rows")
                      , a = parseInt(t.getAttribute("data-start"), 10) || 1
                      , o = a + (s.children.length - 1);
                    n < a && (n = a),
                    o < n && (n = o);
                    var i = n - a;
                    return s.children[i]
        ...
        window.addEventListener("resize", (function() {
            n.assumeViewportIndependence && a === window.innerWidth || (a = window.innerWidth,
            o(Array.prototype.slice.call(document.querySelectorAll("pre." + e))))
        }
        )),
        he.hooks.add("complete", (function(n) {
            if (n.code) {
                ...
                if (a && /pre/i.test(a.nodeName) && !s.querySelector(".line-numbers-rows") && he.util.isActive(s, e)) {
                    ...
                    i.innerHTML = c,
                    a.hasAttribute("data-start") && (a.style.counterReset = "linenumber " + (parseInt(a.getAttribute("data-start"), 10) - 1)),
                    n.element.appendChild(i),
                    o([a]),
                    he.hooks.run("line-numbers", n)
                }
            }
        }
        )),
    ...
    function o(e) {
        if (0 != (e = e.filter((function(e) {
            ...
            n.forEach((function(e) {
                for (var t = e.sizer, n = e.lineHeights, s = 0, a = 0; a < n.length; a++)
                    void 0 === n[a] && (n[a] = t.children[s++].getBoundingClientRect().height)
            }
            )),
            n.forEach((function(e) {
                var t = e.sizer
...
runAllTests.onclick = async e=> {
  ...
  const dbName = 'XS-Leaks'; // Replace with your database name
  ...
  try {
    ...
    const collection = db.collection('results'); // Replace with your collection name
...
const fe = e=>{
  ...
  , Le = ()=>{
    exportModalText.innerText = JSON.stringify(Pe()),
    new ge.Modal("#exportModal",{
        backdrop: !0
    }).show()
}
  , Te = ()=>window.open("/blank.html", "targetWindow", `toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=yes,left=${screen.width - 250},width=250,height=250`)
  , Ae = (e,t,n)=>new Promise(((s,a)=>{
    n.then(s, a),
...
const xe = ()=>{
    if (window.location.hash) {
        ...
        testModal.Modal && testModal.Modal.hide()
}
  , Ce = ()=>{
    if (localStorage.getItem("results"))
        try {
            ...
            for (let t of H) {
                ...
                for (let n of e.testcases)
                    t.test_name === n.test_name && (t.test_result = n.test_result)
            }
  ...
  , Se = ()=>{
    runAllTestsBtn.disabled ? runAllTestsBtn.disabled = !1 : runAllTestsBtn.disabled = !0,
